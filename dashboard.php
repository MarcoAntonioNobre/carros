                        ...
                        <div class="position-absolute top-50 start-50 translate-middle">
                            <form class="d-flex" role="search" id="pesquisaCarro" name="pesquisaCarro">
                                ...
                                <button class="btn btn-outline-light" id="btnPesquisa" name="btnPesquisa"
                                        type="submit"  onclick="pesquisarCarros('btnPesquisa', 'pesquisarCarro', 'inputPesquisa', 'nao', 'pesquisaCarro')">
                                    Buscar
                                </button>
                            </form>
                        </div>
                ...
                <form action="" name="frmCompra" id="frmCompra">
                    <div class="mt-3">
                        <div class="wave-group">
                            ...
                            <div class="mt-3">
                                <div class="wave-group">
                                    <input required="required" min="1" max="500" type="number" class="input" name="inQuantidade"
                                           id="inQuantidade">
                                    <span class="bar"></span>
                                    <label class="label">
