        ...
        <div class="tudo">
            ...
            <div class="container mt-5 text-center bg-black">
                <div class="pt-3 row">
                    ...
                    <div class="col-md-4">
                        <a href="dashboard.php" class="links text-white margem" onclick="carregarConteudo('listarCarros')">Ver Todos</a>
                    </div>
                    <div class="col-md-3">
                    </div>
                    <div class="col-md-4">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <?php
                    $contar = 1;
                    $carros = listarTabela('idcarro, nomeCarro', 'carro');
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="card text-center mt-4" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="#" class="btn btn-outline-dark" onclick="carregarconteudo('comprar')">Ver Mais</a>
                                    </div>
                                </div>
                            </div>
                        <?php
