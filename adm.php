...
<body>
    ...
    <div class="container-fluid">
        <div class="row text-center">
            <div class="col-lg-2 bg-dark vh-100">
                <div class="mt-5 mb-1">
                    <button type="button" class="btn btn-outline-light" onclick="carregarConteudo('listarCarros')">Carros</button>
                </div>
                <div class="mt-3 mb-1">
                    <button type="button" class="btn btn-outline-light" onclick="carregarConteudo('listarProprietarios')">Proprietários</button>
                </div>
                <div class="mt-3 mb-1">
                    <button type="button" class="btn btn-outline-light" onclick="carregarConteudo('listarCliente')">Clientes</button>
                </div>
            </div>
            <div class="col-lg-10">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="#" name="frmDeleteProprietario" id="frmDeleteProprietario">
                    <div class="modal-body">
                        <input type="text" name="idDeleteProprietario" id="idDeleteProprietario">
