            ...
            <div class="modal-content text-center">
                ...
                <form action="#" name="frmAddProprietario" id="frmAddProprietario">
                    ...
                    <div class="input-group2">
                        ...
                        <input type="text" name="nomeProprietario" id="nomeProprietario" class="input2" placeholder="Nome:">
                        <div></div></div>
                    </div>
            ...
            <div class="modal-content text-center">
                ...
                <form action="#" name="frmEditProprietario" id="frmEditProprietario">
                    <div class="modal-body">
                        ...
                        <input type="text" name="nomeEditProprietario" id="nomeEditProprietario" class="input2" placeholder="Nome:">
                        ...
                        <div class="card-body">
                            <form method="post" action="" name="frmCadCliente" id="frmCadCliente">
                                <div>
                                    ...
                                    <input type="text" name="inpNome" id="inpNome" class="form-control" required="required" class="input2" placeholder="Nome:">
                                </div>
                                <div>
                                    <!-- <label for="inpContato" class="label-control">c:</label> -->
                                    <input type="text" name="inpContato" id="inpContato" class="telefoneBR input2" placeholder="Contato:">
                                </div>
                                <div>
                                    <!-- <label for="inpValorUnitario" class="label-control">Valor de cada unidade:</label> -->
                                    <input type="text" name="inpValorUnitario" id="inpValorUnitario" class="dinheiro input2"placeholder="Valor de cada unidade:">
                                </div>
                                <div>
                                    <!-- <label for="inpValorCartao" class="label-control">Valor em cartão:</label> -->
                                    <input type="text" name="inpValorCartao" id="inpValorCartao" class="dinheiro input2" placeholder="Valor em cartão:">
                                </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <form method="post" action="" name="frmEditCliente" id="frmEditCliente">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="inpEditNome" id="inpEditNome" class="input2" required="required" placeholder="Nome:">
                                </div>
                                <div>
                                    <!-- <label for="inpEditContato" class="label-control">Contato:</label> -->
                                    <input type="text" name="inpEditContato" id="inpEditContato" class="input2 telefoneBR" placeholder="Contato:">
                                </div>
                                <div>
                                    <!-- <label for="inpEditValorUnitario" class="label-control">Valor de cada unidade:</label> -->
                                    <input type="text" name="inpEditValorUnitario" id="inpEditValorUnitario" class=" input2 dinheiro" placeholder="Valor de cada unidade:">
                                </div>
                                <div>
                                    <!-- <label for="inpEditValorCartao" class="label-control">Valor em cartão:</label> -->
                                    <input type="text" name="inpEditValorCartao" id="inpEditValorCartao" class="input2 dinheiro" placeholder="Valor em cartão:">
                                </div>
                        </div>
                    </div>
                </div>
