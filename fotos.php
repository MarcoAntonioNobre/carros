<div class="card mt-3">
    <div class="card-header espaco fs-3">
        # Fotos
        <button class="btn btn-outline-dark" data-bs-toggle="modal" onclick="abrirModalJsFoto('nao', 'nao', 'nao', 'nao','nao', 'nao' , '<?php echo DATATIMEATUAL ?>', 'mdlCadFoto', 'A', 'btnCadFoto', 'addFoto', 'nao', 'nao', 'frmCadFoto')">
            Cadastrar
        </button>
    </div>
    <div class=" card-body">
            ...
            <form method="post" action="" name="frmEditFoto" id="frmEditFoto">
                <div class="modal-body">
                        ...
                        <div class="card-body">
                            <div>
                                ...
                                <div>
                                    ...
                                    <input type="file" name="inpEditFoto" id="inpEditFoto" class="input2 mt-3" placeholder="Foto:" required="required">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-outline-primary" id="btnEditFoto">Alterar</button>
                    </div>
            </form>
        </div>
    </div>
