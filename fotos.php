<div class="card mt-3">
    <div class="card-header espaco fs-3">
        # Fotos
        <button class="btn btn-outline-dark" data-bs-toggle="modal" data-bs-target="#mdlCadFoto">Cadastrar</button>
    </div>
    <div class="card-body">
            ...
            if ($foto !== 'Vazio') {
                ...
                foreach ($foto as $fotos) {
                    ...
                    <tr class="text-center">
                        ...
                        <td>
                            <img src="./img/<?php echo $foto; ?>" alt="$nomeCarro" width="50px">
                        </td>
                        <td>
                            <button class="btn btn-outline-primary">Alterar</button>
                            <button class="btn btn-outline-danger" onclick="deletar('apagarFoto',<?php echo $id?>)">Excluir</button>
                        </td>
                    </tr>
