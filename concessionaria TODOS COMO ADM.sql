...
INSERT INTO `adm` (`idadm`,`nomeAdm`,`cpf`,`senha`,`cadastro`,`alteracao`,`ativo`) VALUES 
 ...
 (4,'ARTHUR','111.111.111-11','$2y$12$0njC8V7wLgv7KBs7ZgjAeegwMhwMtAxp4dvdzeHV5N8ShjYs4CWKK','2024-03-22 11:25:03','2024-03-22 11:25:24','A'),
 (5,'CLARISSE','222.222.222-22','$2y$12$5UWs5xnaBILNdKXIeBCwh.RS/oOfO/Y5P7FmvWdOJjQyaKY4K3UY6','2024-03-22 11:26:53','2024-03-22 11:27:11','A'),
 (6,'REBEKA','333.333.333-33','$2y$12$gnkXxXyR/h./.s1wXnh7nO.LTzbTCpFoC.rCZSSnc3s/5rk04V0x.','2024-03-22 11:28:15','2024-03-22 11:28:33','A'),
 (7,'ISADORA','444.444.444-44','$2y$12$1iWLeV3f3MCGHwYAMAMpjuFngectf.rsIS30IOGLL2bP8KqNVHroy','2024-03-22 11:28:41','2024-03-22 11:29:01','A'),
 (8,'FRANCIELE','555.555.555-55','$2y$12$U9Jcr25hz8gkYlEwNPJrgeX8WRpX1arpJW.A5c7Gv7KF1JQCkMfI.','2024-03-22 11:29:05','2024-03-22 11:29:22','A');
...
INSERT INTO `carro` (`idcarro`,`idproprietario`,`nomeCarro`,`diferenciais`,`fotoPerfil`,`preco`,`cadastro`,`alteracao`,`ativo`) VALUES 
 ...
 (5,5,'FBM','CRIAMOS UM CARRO QUE TEM OS SEGUINTES DIFERENCIAIS: LUZ DE LED, APARÊNCIA COM OS CARROS DA FÓRMULA 1, E A ORIGINALIDADE DE NOSSA EMPRESA.','65fd77edbb240_IMG-20240314-WA0019.jpg','150.00','2024-03-15 17:08:32','2024-03-22 09:22:05','A');
...
INSERT INTO `cliente` (`idcliente`,`nomeCliente`,`contato`,`numeroCartao`,`valorCartao`,`cadastro`,`alteracao`,`ativo`) VALUES 
 (1,'MARCO','','111111','97000','2024-03-15 17:10:30','2024-03-23 08:59:11','A'),
 (2,'ARTHUR','','222222','100000','2024-03-15 17:10:30','2024-03-22 09:40:50','A'),
 (3,'FRANCIELE','','333333','100000','2024-03-15 17:10:30','2024-03-22 09:40:40','A'),
 (4,'ISADORA','','444444','100000','2024-03-15 17:10:30','2024-03-22 09:40:32','A'),
 (5,'CLARISSE','','555555','96250','2024-03-15 17:10:30','2024-03-23 09:01:59','A'),
 (7,'REBEKA','','666666','98650','0000-00-00 00:00:00','2024-03-23 09:01:42','A');
...
CREATE TABLE `compras` (
  ...
  `valorUnidade` varchar(255) NOT NULL DEFAULT '0',
  `qtdComprada` varchar(255) NOT NULL DEFAULT '',
  `valorPago` varchar(1000) NOT NULL DEFAULT '0',
  `cadastro` datetime DEFAULT NULL,
  `alteracao` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `ativo` char(1) NOT NULL DEFAULT 'A',
